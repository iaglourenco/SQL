...
CREATE TABLE CURSARAM (RA NUMBER,COD_DISC NUMBER,SEMESTRE VARCHAR2(10),NOTA NUMBER,FREQ NUMBER,STATUS CHAR);
...
BEGIN 
	SELECT VERIFICA(:NEW.RA,:NEW.COD_DISC) INTO A FROM DUAL;
	 ...
	 IF A = 'NAO APTO' THEN
		...
		DBMS_OUTPUT.PUT_LINE('TRIGGER VERIFICA_APTIDAO ATIVADA');
END;
/
...
BEGIN 
 ...
 DBMS_OUTPUT.PUT_LINE('TRIGGER FORMANDO ATIVADA');
END;
/
...
DBMS_OUTPUT.PUT_LINE('TRIGGER ATT_CD ATIVADA');
END;
/
